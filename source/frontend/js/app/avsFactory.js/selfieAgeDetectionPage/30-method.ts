    ...
    export class Method {
        ...
        instance.plugin.Library.Ml.FaceApi.detectFace((faceResult: any) => {
          ...
          instance.plugin.Library.Ml.FaceApi.detectFaceAge((ageResult: any) => {
            ...
            if (ageResult !== null && faceResult !== null) {
              ...
              instance.entity.SelfieAgeDetection.ageResultList.push(
                ageResult.age
              );
              instance.entity.SelfieAgeDetection.averageAge =
                ageResult.averageAge;
              ...
              instance.plugin.Library.Ml.FaceApi.extractFaceImage(
                faceResult.detection,
                (canvasFace: any) => {
                  instance.entity.SelfieAgeDetection.validCanvasFaceList.push(
                    canvasFace[0]
                  );
                  instance.entity.SelfieAgeDetection.validFaceList.push(
                    faceResult
                  );
      ...
      public static checkStep() {
        if (
          ...
          // detecting outliers
          let outlierInstance = new Avs.Helper.Outlier(
            instance.entity.SelfieAgeDetection.ageResultList
          );
          let outlierList = outlierInstance.findOutliers();
          if (outlierList.length > 0) {
            instance.debug.logToContainer(
              "<p>Age outliers found, recalculating average.</p>"
            );
            ...
            for (
              let i = 0,
                j = instance.entity.SelfieAgeDetection.ageResultList.length;
              i < j;
              i++
            ) {
              if (
                !outlierInstance.testOutlier(
                  instance.entity.SelfieAgeDetection.ageResultList[i]
                )
              ) {
                noOutlierList.push(
                  instance.entity.SelfieAgeDetection.ageResultList[i]
            ...
            instance.entity.SelfieAgeDetection.averageAge = parseInt(
              Avs.Helper.Common.calculateAverage(noOutlierList).toFixed()
            );
          }
          ...
          if (instance.entity.SelfieAgeDetection.averageAge == 0) {
            Method.goToFailStep(
              25055,
              "Could not detect any faces from your device video"
            );
            return;
          }
          ...
          instance.debug.logToContainer(
            "<p>Compare image faces for similarity.</p>"
          );
          ...
          for (
            ...
            for (
              let ii = 0,
                jj =
                  instance.entity.SelfieAgeDetection.validCanvasFaceList.length;
              ii < jj;
              ii++
            ) {
              if (i >= ii) {
              ...
              instance.debug.logToContainer(
                Avs.Helper.Canvas.canvasToImage(
                  instance.entity.SelfieAgeDetection.validCanvasFaceList[ii]
                )
              );

              let distance =
                instance.plugin.Library.Ml.FaceApi.compareFaceDescriptors(
                  instance.entity.SelfieAgeDetection.validFaceList[i]
                    .descriptor,
                  instance.entity.SelfieAgeDetection.validFaceList[ii]
                    .descriptor
                );
          ...
          if (
            ...
            instance.debug.logToContainer(
              "<p>Failed due to face comparison threshold: " +
                instance.entity.SelfieAgeDetection.totalInvalidFaceMatch +
                "</p>"
            );
          ...
          if (
            instance.entity.SelfieAgeDetection.averageAge >=
              Config.MIN_ALLOWED_AVERAGE_AGE &&
        ...
        if (
          ...
          Method.goToFailStep(
            25057,
            "Could not detect enough faces from your device video"
          );
          return;
        }
      ...
      public static checkExpressionStep() {
        if (
          ...
          Config.MAX_TOTAL_FACE_EXPRESSION_SCAN_NUMBER
        ) {
          Method.goToFailStep(
            25061,
            "Could not detect enough faces from your device video"
      ...
      public static detectFaceExpression() {
        ...
        instance.plugin.Library.Ml.FaceApi.detectFace((faceResult: any) => {
          ...
          instance.plugin.Library.Ml.FaceApi.detectFaceExpression(
            (faceExpressionResult: any) => {
              instance.debug.logToContainer("<p>Detect face expression.</p>");

              if (
                faceResult !== null &&
                faceExpressionResult !== null &&
                faceExpressionResult.expressionStrongest !== null
              ) {
                instance.ui.SelfieAgeDetectionStatusLabel.stopBlinking();

                instance.debug.logToContainer(
                  "<p>Detection face expression: " +
                    faceExpressionResult.expressionStrongest +
                    "</p>"
                );

                instance.plugin.Library.Ml.FaceApi.extractFaceImage(
                  faceExpressionResult.detection,
                  (canvasFace: any) => {
                    instance.debug.logToContainer(
                      Avs.Helper.Canvas.canvasToImage(canvasFace[0])
                    );
                    ...
                    if (
                      instance.entity.SelfieAgeDetection
                        .validateSmileExpression === null
                    ) {
                      instance.entity.SelfieAgeDetection.validCanvasFaceList.push(
                        canvasFace[0]
                      );
                      ...
                      instance.entity.SelfieAgeDetection.validateSmileExpression =
                        faceExpressionResult.expressionStrongest !==
                        Avs.Plugin.Library.Ml.FaceApi.EXPRESSION_HAPPY;

                      instance.ui.FaceGuideAgeArea.hide();
                      if (
                        instance.entity.SelfieAgeDetection
                          .validateSmileExpression
                      ) {
                      ...
                      instance.debug.logToContainer(
                        "<p>Start looking for the opposite face expression.</p>"
                      );
                    } else {
                      if (
                        (instance.entity.SelfieAgeDetection
                        ...
                        instance.debug.logToContainer(
                          "<p>Face expression found.</p>"
                        );

                        let previousImageIndex =
                          instance.entity.SelfieAgeDetection.validFaceList
                            .length - 1;

                        instance.debug.logToContainer(
                          Avs.Helper.Canvas.canvasToImage(
                            instance.entity.SelfieAgeDetection
                              .validCanvasFaceList[previousImageIndex]
                          )
                        );
                        instance.debug.logToContainer(
                          Avs.Helper.Canvas.canvasToImage(canvasFace[0])
