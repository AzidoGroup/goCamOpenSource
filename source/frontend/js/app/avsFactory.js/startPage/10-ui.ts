  ...
  export namespace StartPage {
    ...
    export class Ui {
      ...
      public static init(): void {
        ...
        const countryToTabVisibilityConfig: { [key:string]: { [key:number]: boolean } } = {
          'DE': {
        ...
        const defaultTab = instance.ui.VerificationTypeTabs.verificationTypeToTabNumber(Config.VERIFICATION_TYPE_DEFAULT);
        instance.ui.VerificationTypeTabs.selectTab(defaultTab);

        const termsWereAgreed = Avs.Helper.Common.getLocalStorageBooleanValue(Config.KEY_LOCAL_STORAGE_TERMS_AGREED);
