      ...
      public static init(): void {
        instance.ui.SelfieAgeDetectionStartButton.onClick(() => {
          if (instance.entity.SelfieAgeDetection.facingMode === null) {
            instance.entity.SelfieAgeDetection.videoDeviceId =
              instance.ui.SelfieAgeDetectionDeviceSelect.getSelectedOption();
          }

          StartPage.Method.showPageStep(
            StartPage.Config.SELFIE_AGE_DETECTION_PAGE_LAYER
          );
