  ...
  export namespace ScanIdAgeVerificationPage {
    export class Config {
      public static create(config: IScanIdAgeVerificationPageConfig) {
        ...
        let verificationStepGlobalEntity =
          Avs.Entity.VerificationStepGlobal.getInstance();
        if (
          verificationStepGlobalEntity.tesseractType ==
            Avs.Entity.VerificationStepGlobal.TESSERACT_TYPE_PRECISE_EN ||
          verificationStepGlobalEntity.tesseractType ==
            Avs.Entity.VerificationStepGlobal.TESSERACT_TYPE_PRECISE_FR
        ) {
          Config.TESSERACT_LANGUAGE_PATH =
            "/static/js/vendor/tesseract-js-core-2.0.0/tessdata/best";
        } else {
          Config.TESSERACT_LANGUAGE_PATH =
            "/static/js/vendor/tesseract-js-core-2.0.0/tessdata/fast";
        }

        if (
          verificationStepGlobalEntity.tesseractType ==
            Avs.Entity.VerificationStepGlobal.TESSERACT_TYPE_FAST_FR ||
          verificationStepGlobalEntity.tesseractType ==
            Avs.Entity.VerificationStepGlobal.TESSERACT_TYPE_PRECISE_FR
        ) {
          Config.TESSERACT_LANGUAGE =
            Avs.Plugin.Library.Ml.Tesseract.LANGUAGE_FR;
        } else {
          Config.TESSERACT_LANGUAGE =
            Avs.Plugin.Library.Ml.Tesseract.LANGUAGE_EN;
        }
      }
      ...
      public static CAMERA_SOURCE_ROOT_ELEMENT_CONTAINER =
        "#scanIdVideoContainer";
      public static CAMERA_SOURCE_ROOT_ELEMENT = "#scanIdVideo";
      public static CAMERA_SOURCE_CANVAS_OVERLAY_ELEMENT =
        "#scanIdVideoOverlayCanvas";
      public static CAMERA_SOURCE_CANVAS_RESULT_ELEMENT =
        "#scanIdVideoResultCanvas";
      public static ID_CARD_GUIDE_CONTAINER = "#idCardGuide";
      public static ID_CARD_GUIDE_BIRTH_DATE_CONTAINER =
        "#idCardGuideBirthDate";

      public static DOCUMENT_PROCESSING_CANVAS_CONTAINER =
        "#documentProcessingCanvasContainer";
      ...
      public static TESSERACT_LANGUAGE =
        Avs.Plugin.Library.Ml.Tesseract.LANGUAGE_FR;
