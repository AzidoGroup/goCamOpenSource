namespace AvsFactory {
  export namespace ScanIdAgeVerificationPage {
    ...
    export function init() {
      let scanIdAgeVerificationEntity =
        Avs.Entity.ScanIdAgeVerification.getInstance();
      let verificationStepGlobalEntity =
        Avs.Entity.VerificationStepGlobal.getInstance();
      let faceApiDetectorType =
        Avs.Plugin.Library.Ml.FaceApi.DETECTOR_TYPE_TINY_FACE_DETECTOR;
      if (
        verificationStepGlobalEntity.faceApiType ==
        Avs.Entity.VerificationStepGlobal.FACE_API_TYPE_PRECISE
      ) {
        faceApiDetectorType =
          Avs.Plugin.Library.Ml.FaceApi.DETECTOR_TYPE_SSD_MOBILE_NET_V1;
      }
          ...
          Library: {
            Ml: {
              FaceApi: {
                ...
                canvasOverlayElementSelector:
                  Config.CAMERA_SOURCE_CANVAS_OVERLAY_ELEMENT,
            ...
            Video: {
              CameraSource: {
                ...
                webrtc: {
                  ...
                  options: {
                    streamVideoInputDevice:
                      scanIdAgeVerificationEntity.videoDeviceId,
      ...
      instance.entity.VerificationStepGlobal.stepId =
        Avs.Entity.VerificationStepGlobal.STEP_SCAN_ID_AGE_VERIFICATION_PAGE;
