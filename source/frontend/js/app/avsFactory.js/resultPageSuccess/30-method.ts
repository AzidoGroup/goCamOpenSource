    ...
    export class Method {
      public static init(): void {
        ...
        if (instance.entity.ScanIdAgeVerification.lowestScanValue > 0) {
          instance.ui.ResultPageSuccessScanIdArea.setContent(
            "<strong>Final document extracted age: " +
        ...
        instance.apiDataChannel
          ...
          .then(
            (successData: ISuccessData) => {
              ...
              instance.entity.VerificationStepGlobal.successPayload =
                successData.successPayload;
            },
            (error: any) => {
              StartPage.Method.showPageStep(
                StartPage.Config.RESULT_PAGE_FAIL_LAYER
              );

              ResultPageFail.init();
              ResultPageFail.Method.renderFailReason(
                error.code + ": Could not save your result"
              );
            }
          );
      }
