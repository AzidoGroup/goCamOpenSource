  ...
  export namespace Ui {
    export namespace Library {
      export class VerificationTypeTabs extends Avs.Ui.Handler.Tabs {
        public static readonly ON_TAB_SELECTED =
          "Ui.Library.VerificationTypeTabs.onTabSelected";
        ...
        public tabNumberToVerificationType(verificationType: number) {
          switch (verificationType) {
            case VerificationTypeTabs.TAB_SELFIE_NUMBER:
              return Avs.Entity.VerificationStepGlobal
                .VERIFICATION_TYPE_SELFIE_AND_SCAN_ID_OPTIONAL;
        ...
        public tabWasSelected(
          tabNumber: number,
          tabData: Avs.Ui.Handler.ITabsEventData
        ) {
