  ...
  export namespace Helper {
    ...
    export class Common {
      ...
      public static getDateInfo(): object {
        ...
        const gmtDate  = userDate.toUTCString();
      ...
      public static getLocalStorageBooleanValue(localStorageIndex: string) {
        ...
        const localStorageValue       = Common.getLocalStorageValue(localStorageIndex);
