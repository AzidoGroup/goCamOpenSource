  ...
  export namespace DataChannel {
    ...
    export class Webrtc {
      ...
      public startStreaming() {
        ...
        const streamVideoInputDevice   = this.config.options.streamVideoInputDevice;
        const facingMode               = this.config.options.facingMode;
        const startFromLowerResolution = this.config.options.startFromLowerResolution;
